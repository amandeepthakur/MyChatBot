package com.example.mychatbot_1.ui
...
class MainActivity : AppCompatActivity() {
    ...
    private val botList = listOf("Aman", "Sandy", "Raj", "Karan")

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main)

        tts = TextToSpeech(this, this::onInit)
        ...
        speakOut("Hello! Today you're speaking with ${botList[random]}, how may I help?")
    }
...
//                btnSpeak!!.isEnabled = true
    ...
    private fun speakOut(text_toSpeak: String) {
        tts!!.speak(text_toSpeak, TextToSpeech.QUEUE_FLUSH, null, "")
    }
        ...
        GlobalScope.launch {
            ...
            withContext(Dispatchers.Main) {
                ...
                when (response) {
                    ...
                    OPEN_SEARCH -> {
                        speakOut("Searching it on Google")
                        val site = Intent(Intent.ACTION_VIEW)
